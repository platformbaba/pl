...
<head>
        ...
        <link rel="stylesheet" href="<?php echo CSS_PATH;?>jqueryui/jqueryui.css" />
        
        <!-- jWysiwyg - https://github.com/akzhan/jwysiwyg/ -->
        <link rel="stylesheet" href="<?php echo JS_PATH;?>/jwysiwyg/jquery.wysiwyg.old-school.css" />
        <script type="text/javascript" src="<?php echo JS_PATH;?>/jwysiwyg/jquery.wysiwyg.js"></script>
        
        
        <!-- Tooltipsy - http://tooltipsy.com/ -->
        <script type="text/javascript" src="<?php echo JS_PATH;?>/tooltipsy.min.js"></script>
        
        <!-- iPhone checkboxes - http://awardwinningfjords.com/2009/06/16/iphone-style-checkboxes.html -->
        <script type="text/javascript" src="<?php echo JS_PATH;?>/iphone-style-checkboxes.js"></script>
        <script type="text/javascript" src="<?php echo JS_PATH;?>/excanvas.js"></script>
        
        <!-- Load zoombox (lightbox effect) - http://www.grafikart.fr/zoombox -->
        <script type="text/javascript" src="<?php echo JS_PATH;?>/zoombox/zoombox.js"></script>
        <link rel="stylesheet" href="<?php echo JS_PATH;?>/zoombox/zoombox.css" />
        
        <!-- Charts - http://www.filamentgroup.com/lab/update_to_jquery_visualize_accessible_charts_with_html5_from_designing_with/ -->
        <script type="text/javascript" src="<?php echo JS_PATH;?>/visualize.jQuery.js"></script>
        
        <!-- Uniform - http://uniformjs.com/ -->
        <script type="text/javascript" src="<?php echo JS_PATH;?>/jquery/jquery.uniform.min.js"></script>
    ...
    <body class="white">
        ...
        <div id="head">
            <div class="left">
                <a href="#" class="button profile"><img src="<?php echo IMG_PATH ;?>icons/huser.png" alt="" /></a>
                Hi, 
                <a href="#">John Doe</a>
                |
                <a href="<?php echo SITEPATH ;?>login?action=logout">Logout</a>
            </div>
            <div class="right">
        ...
        <div id="sidebar">
            <ul>
                <li class="nosubmenu">
                    <a href="dashboard">
                        <img src="<?php echo IMG_PATH ;?>icons/menu/black-dashboard.png" alt="" />
                ...
                <li class="nosubmenu">
                 ...
                 <li><a href="#"><img src="<?php echo IMG_PATH ;?>icons/menu/black-dashboard.png" alt="" /> Admin</a>
                    <ul>
                                                <li><a href="indexb55c.html?p=index">Spots</a></li>
                                                <li class="current"><a href="index7ce9.html?p=forms">Dimensions</a></li>
                                                <li><a href="indexe8b2.html?p=table">Publishers</a></li>
                                                <li><a href="indexa221.html?p=notif">Advertisers</a></li>
                ...
                <li class="current"><a href="#"><img src="admanager/static/img/icons/menu/black-layout.png" alt="" /> Elements</a>
                    <ul>
                                                <li><a href="indexb55c.html?p=index">Dashboard</a></li>
                                                <li class="current"><a href="index7ce9.html?p=forms">Forms</a></li>
                                                <li><a href="indexe8b2.html?p=table">Table</a></li>
                                                <li><a href="indexa221.html?p=notif">Notifications</a></li>
                                                <li><a href="index8c00.html?p=charts">Charts</a></li>
                                                <li><a href="indexec85.html?p=typo">Typography</a></li>
                                                <li><a href="index5850.html?p=calendar">Calendar</a></li>
                                                <li><a href="index637d.html?p=full">Everything on the same page !</a></li>
                    </ul>
                </li>
                <li><a href="#"><img src="admanager/static/img/icons/menu/black-color.png" alt="" /> Alternate colors</a>
                    <ul>
                        <li><a href="indexeac0.html?p=forms&amp;c=white"><span style="color:#FFF;">White</span></a></li>
                        <li><a href="indexe5fc.html?p=forms&amp;c=black"><span style="color:#000;">Black</span></a></li>
                        <li><a href="indexa790.html?p=forms&amp;c=wood"><span style="color:#624A3E;">Wood</span></a></li>
                    </ul>
                </li>
                 -->
...
<div id="content">
 <?php 
                	if(sizeof($messenger['successmsg'])>0){
						foreach ($messenger['successmsg'] as $msg )
                			echo '<div class="notif tip">
                   				'.$msg.'
                    			<a href="#" class="close"></a> </div>';	
                	}
                	if(sizeof($messenger['errormsg'])>0){
                		foreach ($messenger['errormsg'] as $msg )
