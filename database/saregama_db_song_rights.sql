...
--
-- Table structure for table `song_rights`
--

DROP TABLE IF EXISTS `song_rights`;
...
--
-- Dumping data for table `song_rights`
--

LOCK TABLES `song_rights` WRITE;
/*!40000 ALTER TABLE `song_rights` DISABLE KEYS */;
/*!40000 ALTER TABLE `song_rights` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-23 14:24:51
