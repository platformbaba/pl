...
--
-- Table structure for table `video_rights`
--

DROP TABLE IF EXISTS `video_rights`;
...
--
-- Dumping data for table `video_rights`
--

LOCK TABLES `video_rights` WRITE;
/*!40000 ALTER TABLE `video_rights` DISABLE KEYS */;
/*!40000 ALTER TABLE `video_rights` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-23 14:28:05
