...
--
-- Table structure for table `album_rights`
--

DROP TABLE IF EXISTS `album_rights`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `album_rights` (
...
--
-- Dumping data for table `album_rights`
--

LOCK TABLES `album_rights` WRITE;
/*!40000 ALTER TABLE `album_rights` DISABLE KEYS */;
/*!40000 ALTER TABLE `album_rights` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-23 14:28:20
