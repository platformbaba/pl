...
--
-- Table structure for table `text_rights`
--

DROP TABLE IF EXISTS `text_rights`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `text_rights` (
...
--
-- Dumping data for table `text_rights`
--

LOCK TABLES `text_rights` WRITE;
/*!40000 ALTER TABLE `text_rights` DISABLE KEYS */;
/*!40000 ALTER TABLE `text_rights` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-23 14:24:05
