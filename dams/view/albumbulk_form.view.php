...
<!--            
    CONTENT 
			-->
<div id="content">
  <h1><img src="<?php echo IMGPATH; ?>icons/song_icon.png" alt="" width='40' height='40'/>Manage Album Bulk Upload</h1>
  <?php
		/* To show errorr */
		if( !empty($aError) ){
			$aParam = array(
    ...
    <div class="content">
      <form id='srcFrm' name='srcFrm' method='POST' enctype="multipart/form-data">
        ...
        <div class="submit" align='right'>
		  ...
		  <input type="button" name="Cancel" value="Cancel" onclick="window.location = '/cms/albumbulk?action=view' " /> 
        </div>
        <div class="cb"></div>
      </form>
    </div>
