...
<div id="content">
	<div>
		<span class='FL'><h1><img src="<?php echo IMGPATH; ?>icons/delievery.png" alt="" width='40' height='40'/>Manage IMI Deployment</h1></span>
		<span class='FR MT40'>
			  		<?php echo '<a href="'.SITEPATH.'report-deployment?srcDepType=IMI&action=view" title="Deployment Audit Report" class="button">Report</a>'; ?>
			<?php if ($this->user->hasPrivilege(strtolower(MODULENAME)."_add")){ echo '<a href="'.SITEPATH.'imi-deployment?action=add" title="Add New" class="button">Add New</a>'; } ?>
		</span>
		<br class='clear' />
	</div>
	<?php
		...
		<table>
            ...
            <tbody>
				...
				<tr>
					...
					<td><a href="<?=SITEPATH?>imi-deployment?action=view&id=<?=$showData->deployment_id?>&do=details&isPlane=1" title="view deployment details" class="fancybox fancybox.iframe"><?php echo $showData->deployment_name; ?></a></td>
