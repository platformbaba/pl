<!--            
              CONTENT 
                        --> 
        <div id="content">
                                                <h1><img src="<?php echo IMGPATH; ?>icons/dashboard.png" alt="" />Dashboard
</h1>
    ...
    <div class="content dashboard">
        <div class="center">
            <a href="#" class="shortcut">
                <img src="<?php echo IMGPATH; ?>page.png" alt="" width="48" height="48"/>
                Write an Article
            </a>
            <a href="#" class="shortcut">
                <img src="<?php echo IMGPATH; ?>picture.png" alt="" width="48" height="48" />
                Write an Article
            </a>
            <a href="#" class="shortcut">
                <img src="<?php echo IMGPATH; ?>contact.png" alt="" width="48" height="48" />
                Manage contacts
            </a>
            <a href="#" class="shortcut last">
                <img src="<?php echo IMGPATH; ?>event.png" alt="" width="48" height="48" />
                Manage events
            </a>
            <div class="cb"></div>
        </div>
...
<div class="bloc">
    ...
    <div class="content">
        <a href="indexec85.html?p=typo" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/font.png" alt="" />
            Typography
        </a>
        <a href="indexe8b2.html?p=table" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/window.png" alt=""  width="32" height="32"/>
            Table
        </a>
        <a href="indexa221.html?p=notif" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/warning.png" alt=""  width="32" height="32"/>
            Notifications
        </a>
        <a href="index7ce9.html?p=forms" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/posts.png" alt=""  width="32" height="32"/>
            Forms
        </a>
        <a href="index8c00.html?p=charts" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/chart.png" alt=""  width="32" height="32"/>
            Charts
        </a>
        <a href="index5850.html?p=calendar" class="shortcut">
            <img src="<?php echo IMGPATH; ?>icons/calendar.png" alt=""  width="32" height="32"/>
            Calendar
        </a>
        <div class="cb"></div>
    </div>
</div>                                    <h1><img src="<?php echo IMGPATH; ?>icons/posts.png" alt="" />Forms</h1>
...
</div>                                    <h1><img src="<?php echo IMGPATH; ?>icons/posts.png" alt="" />Table</h1>
<div class="bloc">
    <div class="title">
        Table Content
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Catégories</th>
                    <th>Tags</th>
                    <th><img src="<?php echo IMGPATH; ?>th-comment.png" alt="" /></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <td>35</td>
                    <td class="actions"><a href="#" title="Edit this content"><img src="<?php echo IMGPATH; ?>icons/edit.png" alt="" /></a><a href="#" title="Delete this content"><img src="<?php echo IMGPATH; ?>icons/delete.png" alt="" /></a></td>
                </tr>
                                <tr>
                    <td><input type="checkbox" /></td>
                    <td><a href="#">Lorem ipsum</a></td>
...
<div class="bloc">
    ...
    <div class="content">
        <table class="noalt">
            <tbody>
                                <tr>
                    <td class="picture" style="width:80px;"><img src="<?php echo IMGPATH; ?>anonymous.png" alt="" /></td>
                    <td>
                        <p>
...
<h1><img src="<?php echo IMGPATH; ?>icons/warning.png" alt="" />Notifications</h1>
...
<h1><img src="<?php echo IMGPATH; ?>icons/chart.png" alt="" />Charts</h1>
...
<h1><img src="<?php echo IMGPATH; ?>icons/font.png" alt="" />Typography</h1>
...
<h1><img src="<?php echo IMGPATH; ?>icons/calendar.png" alt="" />Calendar</h1>
