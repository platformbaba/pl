...
<div class="bloc" style="margin-top:0px;">
    <div class="title"><?=ucfirst($_GET['action'])?> Song Rights<div align="right"><span class='mandatory'>*&nbsp;</span>Mandatory Fields.</div></div>
    <div class="content">
  ...
  //  [digital_rights] => 2|4|8|16
		...
		<div class="submit">
			...
			<input type="hidden" name="songRightId" value="<?=$aContent['is_owned']?>" />
        </div>
		<?php } ?>
	</form>
    </div>
