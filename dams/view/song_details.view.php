    ...
    <div class="content">
      <form method="post" enctype="multipart/form-data">
		...
		<div class="clearfix">
          ...
          <label for="input1">Song Title</label>
          <div class='text-field-disabled'>
		  <?=$aContent['songName']?>
		  </div>
		  </div>
		  <div class="input FL50">
          <label for="input1">Song Id</label>
          <div class='text-field-disabled'>
		  <?=$aContent['songId']?>
		  </div>
		  </div>
        ...
        <div class="clearfix">
          ...
          <div class="input FL50">
            <label for="input1">Track/Clip Duration (in sec)</label>
            <div class='text-field-disabled'>
			<?=$aContent['songDuration']?>
			</div>
          </div>
        </div>
        <div class="clearfix">
        ...
        <div class="clearfix">
          <div class="input FL50">
            <label for="input4">Audio File Path</label>
            <div class='text-field-disabled'>
			<?=$aContent['audioFilePath']?>
			</div>
          </div>
        </div>
        <div class="input">
