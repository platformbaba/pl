...
<!--            
    CONTENT 
			-->
<div id="content">
  <h1><img src="<?php echo IMGPATH; ?>icons/song_icon.png" alt="" width='40' height='40'/>Manage Video Bulk Upload</h1>
  <?php
		/* To show errorr */
		if( !empty($aError) ){
			$aParam = array(
  ...
  <!-- Search Box start -->
  <div class="bloc">
    <div class="title"> Upload bulk video .csv file <a class="toggle" href="#"></a></div>
    <div class="content">
      <form id='srcFrm' name='srcFrm' method='POST' enctype="multipart/form-data">
        <div class="clearfix">
		  ...
		  <div class="input FL50">
            ...
            <a href="javascript:top.location='<?=MEDIA_SITEPATH_TEMP?>bulk/video_bulk.csv';" class="button">Download</a>
          </div>
        </div>
