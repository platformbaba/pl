...
<div id="content">
	<div>
		<span class='FL'><h1><img src="<?php echo IMGPATH; ?>icons/song_icon.png" alt=""  height="45px" width="45px" />Manage Video Bulk Upload</h1></span>
		<span class='FR MT40'>
			<?php if ($this->user->hasPrivilege(strtolower(MODULENAME)."_add")){ echo '<a href="'.SITEPATH.'videobulk?action=add" title="Add New" class="button">Add New</a>'; } ?>
		</span>
		<br class='clear' />
	</div>
...
<div class="bloc">
    <div class="title">
        Bulk Video Upload Batch Lists <b class='sCount'>(<?=$iTotalCount?>)</b>
    </div>
    <div class="content">
		...
		<table>
            ...
            <tbody>
				...
				<tr>
					...
					<a href="<?=SITEPATH?>videobulk?action=edit&bid=<?=$showData->batch_id?>" title="Edit this content"><img src="<?=IMGPATH?>icons/edit.png" alt="" /></a>
					</td>
                </tr>
				<?php
					} /* foreach end */
