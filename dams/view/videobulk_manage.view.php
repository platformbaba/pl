...
<form id='srcFrm' name='srcFrm' method='post' enctype="multipart/form-data">
	...
	<div class="content" style="<?=$class?>">
        <div class="clearfix">
          <div class="input FL PR5">
            ...
            <input type="text" id="video_title_<?=$showData->id?>" name="video_title[<?=$showData->id?>]" value="<?php echo $showData->video_title; ?>" class="WD150 " />
          </div>
		  <div class="input FL PR5">
            <label for="input">Song ISRC :</label>
            <input type="text" id="song_isrc_<?=$showData->id?>" name="song_isrc[<?=$showData->id?>]" value="<?php echo $showData->song_isrc; ?>" class="WD150 " />
			<span class="error-message"><?=$remarks['song_isrc']?></span>
          </div>
		  <div class="input FL PR5">
		  ...
		  <div class="input FL PR5">
            ...
            <input type="text" id="video_language_<?=$showData->id?>" name="video_language[<?=$showData->id?>]" value="<?php echo $showData->video_language; ?>" class="WD150 " />
			<span class="error-message"><?=$remarks['video_language']?></span>
          </div>
		  <div class="input FL PR5">
		  ...
		  <div class="input FL PR5">
			<label for="input">Video Duration :</label>
            <input type="text" id="video_duration_<?=$showData->id?>" name="video_duration[<?=$showData->id?>]" value="<?php echo $showData->video_duration; ?>" class="WD150 "/>
		  </div>
		  <div class="input FL PR5">
		  ...
		  <div class="input FL PR5">
            ...
            <input type="text" id="director_<?=$showData->id?>" name="director[<?=$showData->id?>]" value="<?php echo $showData->director; ?>" class="autosuggestmdirector WD150 "/>
			<?php
		  ...
		  <div class="input FL PR5">
			<label for="input">Video File Path :</label>
            <input type="text" id="video_file_path_<?=$showData->id?>" name="video_file_path[<?=$showData->id?>]" value="<?php echo $showData->video_file_path; ?>" class="WD150 "/>
			<span class="error-message"><?=$remarks['video_file_path']?></span>
		  </div>
		  <div class="input FL PR5">
			<label for="input">Image File Path :</label>
            <input type="text" id="image_file_path_<?=$showData->id?>" name="image_file_path[<?=$showData->id?>]" value="<?php echo $showData->image_file_path; ?>" class="WD150 "/>
			<span class="error-message"><?=$remarks['image_file_path']?></span>
		  </div>
  		</div>
		...
		var mdirectorOptions, mdirectorautocom;
			jQuery(function(){
			  mdirectorOptions = { serviceUrl:'<?=SITEPATH?>ajax?action=view&type=director', minChars:2,width:230,  delimiter: /(,|;)\s*/ ,class : "autosuggestmdirector"};
			  mdirectorautocom = $('#director_<?=$showData->id?>').autocomplete(mdirectorOptions);
			});	
	...
	<div class="submit" align='left' >
		  ...
		  ?>
		  <input type="button" name="Cancel" value="Cancel" onclick="window.location = '/cms/videobulk?action=view' " /> 
    </div>
</form>  
<!-- Search Box end -->
</div>
