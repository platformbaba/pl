...
<form id='srcFrm' name='srcFrm' method='post' enctype="multipart/form-data">
	...
	<div class="content" style="<?=$class?>">
        <div class="clearfix">
		  <div class="input FL PR5">
            <label for="input">Image Title :</label>
            <input type="text" id="image_title_<?=$showData->id?>" name="image_title[<?=$showData->id?>]" value="<?php echo $showData->image_title; ?>" class="WD150 " />
			<span class="error-message"><?=$remarks['image_title']?></span>
          </div>
		  <div class="input FL PR5">
            <label for="input">Image Type :</label>
            <input type="text" id="image_type_<?=$showData->id?>" name="image_type[<?=$showData->id?>]" value="<?php echo $showData->image_type; ?>" class="WD150 " />
			<span class="error-message"><?=$remarks['image_type']?></span>
          </div>
		  <div class="input FL PR5">
            <label for="input">Image Description :</label>
            <input type="text" id="image_description_<?=$showData->id?>" name="image_description[<?=$showData->id?>]" value="<?php echo $showData->image_description; ?>" class="WD150 " />
          </div>
		  <div class="input FL PR5">
	...
	<div class="submit" align='left' >
		  ...
		  ?>
		  <input type="button" name="Cancel" value="Cancel" onclick="window.location = '/cms/imagebulk?action=view' " /> 
    </div>
</form>  
<!-- Search Box end -->
</div>
