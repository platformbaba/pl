...
<div id="content">
	<div>
		<span class='FL'><h1><img src="<?php echo IMGPATH; ?>icons/delievery.png" alt="" width='40' height='40'/>Manage Spice Deployment</h1></span>
		<span class='FR MT40'>
			<?php echo '<a href="'.SITEPATH.'report-deployment?srcDepType=SPICE&action=view" title="Deployment Audit Report" class="button">Report</a>'; ?>
			<?php if ($this->user->hasPrivilege(strtolower(MODULENAME)."_add")){ echo '<a href="'.SITEPATH.'spice-deployment?action=add" title="Add New" class="button">Add New</a>'; } ?>
		</span>
		<br class='clear' />
	</div>
	<?php
...
<div class="bloc">
    ...
    <div class="content" style=" display:none">
		<form id='bulkFrm' name='bulkFrm' method='post' enctype="multipart/form-data" action="<?=CONTROLLERSITEPATH?>spice-bulk-upload.cntrl.php">
		<div class="clearfix">
			<div class="input FL50">
		...
		<div class="submit" align='right'>
			<input type="submit" value="Bulk Upload" name="submitBulk" style='margin:0 auto' />
		</div>
		...
		<table>
            ...
            <tbody>
				...
				<tr>
					...
					<td><a href="<?=SITEPATH?>spice-deployment?action=view&id=<?=$showData->deployment_id?>&do=details&isPlane=1" title="view deployment details" class="fancybox fancybox.iframe"><?php echo $showData->deployment_name; ?></a></td>
