...
<div id="content">
	<div>
		<span class='FL'><h1><img src="<?php echo IMGPATH; ?>icons/delievery.png" alt="" width='40' height='40'/>Manage Reliance Deployment</h1></span>
		<span class='FR MT40'>
			<?php echo '<a href="'.SITEPATH.'report-deployment?srcDepType=RELIANCEAUDIO&action=view" title="Deployment Audit Report" class="button">Report</a>'; ?>
		...
		<table>
            ...
            <tbody>
				...
				<tr>
					...
					<td><a href="<?=SITEPATH?>reliance-audio-deployment?action=view&id=<?=$showData->deployment_id?>&do=details&isPlane=1" title="view deployment details" class="fancybox fancybox.iframe"><?php echo $showData->deployment_name; ?></a></td>
