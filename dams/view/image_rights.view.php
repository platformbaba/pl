...
<div class="bloc" style="margin-top:0px;">
    <div class="title"><?=ucfirst($_GET['action'])?> Image Rights<div align="right"><span class='mandatory'>*&nbsp;</span>Mandatory Fields.</div></div>
    <div class="content">
	<form method="post" enctype="multipart/form-data" >
		...
		<div class="col3 clearfix">	
			<div class="input FL50"><p class="titleLab">Publishing Rights :</p>	
				<?php
	//			 [publishing_rights] => 1|4
  //  [digital_rights] => 2|4|8|16
		...
		<div class="submit">
			...
			<input type="hidden" name="imageRightId" value="<?=$aContent['is_owned']?>" />
        </div>
		<?php } ?>
	</form>
    </div>
